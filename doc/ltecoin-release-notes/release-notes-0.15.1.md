Ltecoin Core version *0.15.1* is now available from:

  <https://download.Ltecoin.org/Ltecoin-0.15.1/>
...
A number of changes to the way Ltecoin Core deals with peer connections and invalid blocks
