# Support for Output Descriptors in Ltecoin Core

Since Ltecoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Ltecoin Core wallets, a convenience function `combo` is
