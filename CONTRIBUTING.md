Contributing to Ltecoin Core
============================

The Ltecoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Ltecoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/Ltecoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to Ltecoin-qt
...
The following applies to code changes to the Ltecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ltecoin
Network Protocol consensus changes.

Whether a pull request is merged into Ltecoin Core rests with the project merge
...
Patches that change Ltecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ltecoin consensus, it must have been
...
The project leader is the release manager for each Ltecoin Core release.
