...
const char * const BITCOIN_CONF_FILENAME = "Ltecoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ltecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Ltecoin";
#else
    // Unix-like
    return pathRet / ".Ltecoin";
#endif
#endif
}
