...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.Ltecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.Ltecointools.com");
        vSeeds.emplace_back("dnsseed.Ltecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.Ltecointools.com");
        vSeeds.emplace_back("seed-b.Ltecoin.loshan.co.uk");
