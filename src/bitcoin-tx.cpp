...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " Ltecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  Ltecoin-tx [options] <hex-tx> [commands]  Update hex-encoded Ltecoin transaction\n" +
            "or:     Ltecoin-tx [options] -create [commands]   Create hex-encoded Ltecoin transaction\n" +
            "\n";
