...
"""Verify that starting Ltecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Ltecoin with -h for help text")
        ...
        self.log.info("Start Ltecoin with -version for version information")
        ...
        self.log.info("Start Ltecoind with -fakearg to make sure it does not start")
